...
AS
SELECT ean,cat,EXTRACT(YEAR FROM instante) as trimestre,EXTRACT(QUARTER FROM instante) as ano, EXTRACT(MONTH FROM instante) as mes, EXTRACT(DAY FROM instante) as dia_mes,
